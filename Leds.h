...
#define LEDS_INIT() TRISE = 0x00; LATE = 0x00; //Set all pins to output to work with leds 1-8, Initialize all led's as off 
 ...
 */
#define LEDS_SET(newPattern) LATE = newPattern; //set leds to given value value
 ...
 */
#define LEDS_GET() return LATE; //returns LATE register
